...
public class TestTtcPriceFr {
    ...
    public void testTTCPrice() {
        final Item i = new Item("Counter strike", 0.196d*60.0d+60.0d);

        final Cart c = new Cart();
        c.addProduct(i, 2);
        c.addProduct(new Item("Tomates", 0.196d*20.0d+20.0d), 5);

        assertTrue(263.12d == c.computePrice());
